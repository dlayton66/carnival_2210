...
RSpec.describe Ride do
  ...
  describe '#board_rider' do
    ...
    it 'boards riders based on preferences and height' do
      visitor1.add_preference(:gentle)
      visitor2.add_preference(:gentle)
      ...
      expect(visitor1.spending_money).to eq(8)  # wrong preference
      expect(visitor2.spending_money).to eq(4)  # wrong height
      expect(visitor3.spending_money).to eq(13) # just right
